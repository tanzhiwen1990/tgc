...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="${ctx}/friendLink/friendLink_add" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公司名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" dataType="s" placeholder="公司名称" id="" name="companyname">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea   class="input-text dataType="*" placeholder="公司描述" id="" name="description"></textarea>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="公司Url" dataType="url" id="" name="linkurl">
			</div>
		</div>
