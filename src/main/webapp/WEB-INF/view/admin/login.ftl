...
<link href="${ctx}/lib/Hui-iconfont/1.0.7/iconfont.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="index.html" method="post" onsubmit="return false">
      <div class="row cl">
...
<script type="text/javascript">
	function loginCaptcha(){
		...
		$.get('${ctx}/adminLogin/captcha', {
			captcha : $('#captcha').val()
		},function(result) {
			if(result.data.success == "false"){
				layer.alert('验证码错误!',{time: 2000});
			}else{
				login();
			}
		}, 'json');
		...
		$.ajax({ 
	        ...
	        success: function(result) { 
	            if(result.data == "false"){
	            	...
	            	window.location.href = "${ctx}/adminLogin/goIndex";
	            }
	        }
		});
	}
