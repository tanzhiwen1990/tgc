            ...
            <#list list as l>
                <li class="item">
                    <div class="portfoliobox">
                        <input class="checkbox" name="checkname" type="checkbox" value="${l.house_picture_id}">
                        <div class="picbox"><a href="${basePath}${l.house_picture_addr}" data-lightbox="gallery" data-title="图片"><img src="${basePath}${l.house_picture_addr}"></a></div>
                    </div>
                </li>
            </#list>
        <#else>
...
<script type="text/javascript">
    ...
    function deletePicture(){
        ...
        layer.confirm('确认要删除一张或多张图片吗？',function(){
            $.ajax({
                type: "post",
                url: "${basePath}" + "house/deletePicture",
                data: {
                    ids : ids
                },
                dataType: "json",
  ...
  function(){ 
    ...
    $(function(){
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: '${basePath}house/HouseUp_Files',
