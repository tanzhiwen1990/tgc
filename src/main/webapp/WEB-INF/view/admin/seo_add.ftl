...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="${ctx}adminSeo/seo_add" method="Post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="标题" id="name" dataType="*" name="title" style="width:200px;">
			</div>
		</div>
	  ...
	  <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			   <textarea name="keyword" id="keyword" rows="5"  dataType="*" cols="80"></textarea> 
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			   <textarea name="description" id="description" rows="5"  dataType="*" cols="80"></textarea> 
			</div>
		</div>
