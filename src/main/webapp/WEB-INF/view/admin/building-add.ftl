    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="输入楼盘名称" id="building_name" name="building_name">
            </div>
        </div>
        
         <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>楼盘介绍：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea  name="SEO_describe" style="width:100%;height:200px;" placeholder="介绍写点什么...最少输入10个字符！" onKeyUp="textarealength(this,10000)"></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" id="Trade_Area" name="Trade_Area">
                    <option value="" selected>请选择商圈</option>
                </select>
				</span> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="楼盘地址" id="building_addr" name="building_addr">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                建筑年代：<input type="text" name="building_year" id="building_year" placeholder="输入建筑年代" value="" class="input-text" style=" width:25%">年
                停车位：<input type="text" name="building_car" id="building_car" placeholder="输入停车位" value="" class="input-text" style=" width:25%">个
                停车费用：<input type="text" name="building_car_money" id="building_car_money" placeholder="输入停车费用" value="" class="input-text" style=" width:25%">元
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"></label>
            <div class="formControls col-xs-8 col-sm-9">
                物业公司：<input type="text" name="building_property" id="building_property" placeholder="输入物业公司" class="input-text" style=" width:40%">
                开发商：<input type="text" name="building_developers" id="building_developers" placeholder="输入开发商" class="input-text" style=" width:40%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"></label>
            <div class="formControls col-xs-8 col-sm-9">
                竣工时间：<input type="text" name="building_repairtime" id="building_repairtime" placeholder="选择竣工时间" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'%y-%M-%d'})" id="logmin" class="input-text Wdate" style=" width:25%">
                总建筑面积：<input type="text" name="building_acreage" id="building_acreage" placeholder="输入总建筑面积" value="" class="input-text" style=" width:25%">㎡
                级别：<input type="text" name="building_level" id="building_level" placeholder="输入级别" value="" class="input-text" style=" width:25%">
            </div>
        </div>
        <div class="row cl">
         ...
         <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>物业费用：</label>
            <div class="formControls col-xs-8 col-sm-9">
               <input type="text" name="building_property_money" id="building_property_money" placeholder="输入物业费用" value="" class="input-text" style=" width:51%"> 
         ...
         <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="售价" id="building_price" name="building_price"   style=" width:51%">
                <span class="select-box" style="width: 120px">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  id="min" placeholder="输入最低租金" name="min" class="input-text" style=" width:25%">-
                <input type="text"  id="max" placeholder="输入最高租金"  class="input-text" style=" width:25%">
                <span class="select-box" style="width: 120px">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="0" placeholder="" id="building_sort" name="building_sort">
            </div>
        </div>
       
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">交通状况介绍：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="building_traffic" id="building_traffic" cols="" rows="" class="textarea"  placeholder="交通状况介绍"></textarea>
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    $("#form-article-add").validate({
        ...
        submitHandler:function(form){
            ...
            if(isState){
                $.ajax({
                    type: "post",
                    url: "${basePath}" + "building/inesrt",
                    data:$(form).serialize()+"&cityName="+city +"&districtName=" + district +"&trade_AreaName=" + trade_Area + "&position=" + position+ "&building_rent=" + rent,
                    dataType: "json",
                    success: function(result) {
                        if(result.data != true){
   ...
   $(function(){
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: '${basePath}building/up_Files',
