          ...
          + '<ul class="nav navbar-nav navbar-right" id="nav" style="max-width:100%;">'
            ...
            + '<li class="dropdown ' + (activeClass.spreadsheet || '') + '">'
              ...
              + '<ul class="dropdown-menu">'
                ...
                + (enVersion ? '' : '<li><a  href="http://study.163.com/course/courseMain.htm?courseId=1016007">视频教程</a></li>')
              + '</ul>'
            + '</li>'
            /*
            + '<li class="dropdown">'
         ...
         '<div class="container">'
            + '<div class="row" style="padding-bottom:20px;">'
                + '<div class="col-md-3">'
                    ...
                    + '<ul>'
                        + '<li><a href="http://tushuo.baidu.com/" >Baidu 图说</a></li>'
                        + '<li><a href="' + (enVersion ? "http://ecomfe.github.io/echarts-x" : 'http://echarts.baidu.com/x/doc') + '" >ECharts-X</a></li>'
                        + '<li><a href="http://ecomfe.github.io/zrender/index.html" >ZRender</a></li>'
                        + '<li><a href="https://github.com/pissang/qtek" >QTEK</a></li>'
                    + '</ul>'
                + '</div>'
                + '<div class="col-md-3">'
                    + '<p>' + (enVersion ? 'More' : '更多') + '</p>'
                    + '<ul>'
                        + '<li><a href="https://github.com/ecomfe/echarts/blob/master/LICENSE.txt" >License</a></li>'
                        + '<li><a href="http://echarts.baidu.com/doc/changelog' + (enVersion ? '-en' : '') + '.html" >Changelog</a></li>'
                        + '<li><a href="http://efe.baidu.com" >Baidu EFE</a></li>'
                        + '<li><a href="http://www.oschina.net/p/echarts" >' + (enVersion ? 'Open Source China' : '开源中国') + '</a></li>'
                    + '</ul>'
                + '</div>'
                + '<div class="col-md-3">'
                    ...
                    + '<ul>'
                        ...
                        + '<li><a href="https://github.com/ecomfe/echarts" > Github</a></li>'
                        + '<li><a href="http://weibo.com/echarts" >Weibo</a></li>'
                    + '</ul>'
                + '</div>'
            ...
            + '<p>&copy; 2015 <a href="http://www.baidu.com/" >Baidu</a></p>'
        + '</div>';
}
