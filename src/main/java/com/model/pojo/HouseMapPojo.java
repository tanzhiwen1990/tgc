...
import com.model.Child_Domain;
import com.model.House_Picture;

public class HouseMapPojo {
	/**
	 * 房源编号
	 */
	 ...
	 * 图片
	 */
	private House_Picture House_Picture_id;
	/**
	 * 名称
	 */
	...
	public HouseMapPojo(int house_id, Building building_id, Child_Domain child_domain_id,
			House_Picture house_Picture_id, String house_name, float house_money, String house_type, float house_mi,
			String house_num, String house_orientation, String house_decoration_type, String house_address,
			String house_intime, String house_linkman, String house_phone, String house_sale_state, String house_style,
			String house_ishot, String house_state, String house_userName, String longitude, String latitude,
			Date house_time, String sEO_title, String sEO_describe, String sEO_keyword,String house_unit) {
		super();
		this.house_id = house_id;
		this.building_id = building_id;
		this.child_domain_id = child_domain_id;
		House_Picture_id = house_Picture_id;
	...
	public House_Picture getHouse_Picture_id() {
		return House_Picture_id;
	}
	public void setHouse_Picture_id(House_Picture house_Picture_id) {
		House_Picture_id = house_Picture_id;
	}
	...
	public float getHouse_money() {
		return house_money;
	}
	public void setHouse_money(float house_money) {
		this.house_money = house_money;
	}
	...
	public float getHouse_mi() {
		return house_mi;
	}
	public void setHouse_mi(float house_mi) {
		this.house_mi = house_mi;
	}
